...
static unsigned char regular[0x48] =  {0xc0,PS2_Q,0xcf,PS2_SPACE,0xd0,0xcd,0xce,PS2_1
                                        ,PS2_4,PS2_E,PS2_S,PS2_Z,PS2_LSHIFT,PS2_A,PS2_W,PS2_3
                                        ,0xc1,PS2_T,PS2_F,PS2_C,PS2_X,PS2_D,PS2_R,PS2_5
                                        ,0xc3,PS2_U,PS2_H,PS2_B,PS2_V,PS2_G,PS2_Y,0xc2
                                        ,0xc5,PS2_O,PS2_K,PS2_M,PS2_N,PS2_J,PS2_I,0xc4
                                        ,PS2_MINUS,0xc7,0xc9,PS2_PERIOD,PS2_COMMA,PS2_L,PS2_P,0xc6
                                        ,0xd2,0xcc,0xcb,PS2_LSHIFT,PS2_SLASH,0xca,0xc8,0xff
                                        ,0xd3,0xd4,0xd5,0xd6,0xd7,0xd8,PS2_ENTER,PS2_BS
...
static unsigned char mappings[2][25][2][2] = {
                                          // default mappings
                                         {
                                          {{0,PS2_2},{SCAN_MAP_SHIFT,PS2_APOSTROPHE}},  //0xc0
                                          {{0,PS2_6},{SCAN_MAP_SHIFT,PS2_7}},           //0xc1
                                          {{0,PS2_7},{0,PS2_APOSTROPHE}},           //0xc2
                                          {{0,PS2_8},{SCAN_MAP_SHIFT,PS2_9}},           //0xc3
                                          {{0,PS2_9},{SCAN_MAP_SHIFT,PS2_0}},           //0xc4
                                          {{0,PS2_0},{0,0}},  // shift-0?           //0xc5
                                          {{SCAN_MAP_SHIFT,PS2_EQUALS},{0,0}}, // shift+  0xc6
                                          {{SCAN_MAP_SHIFT,PS2_2},{0,0}}, // shift @?     0xc7
                                          {{SCAN_MAP_SHIFT,PS2_8},{0,0}}, // shift *?     0xc8
                                          {{SCAN_MAP_SHIFT,PS2_SEMICOLON},{0,PS2_LBRACKET}},  // 0xc9
                                          {{0,PS2_SEMICOLON},{0,PS2_RBRACKET}},     //0xca
                                          {{0,PS2_EQUALS},{0,0}}, // shift =?         0xcb
                                          {{SCAN_MAP_SHIFT,PS2_6},{0,0}}, // shift ^?     0xcc
                                          {{0,PS2_LCTRL},{SCAN_MAP_SHIFT,PS2_LCTRL}}, // control
                                          {{0,PS2_ESC},{SCAN_MAP_SHIFT,PS2_ESC}}, // <-
                                          {{0,PS2_ALT},{SCAN_MAP_SHIFT,PS2_ALT}}, // C=
                                          {{0,PS2_TAB},{SCAN_MAP_SHIFT,PS2_TAB}}, // RUN-STOP
                                          {{SCAN_MAP_EXT,PS2_DEL},{SCAN_MAP_EXT | SCAN_MAP_SHIFT,PS2_DEL}},// RESTORE
                                          {{SCAN_MAP_EXT,PS2_HOME},{SCAN_MAP_SHIFT | SCAN_MAP_EXT,PS2_HOME}}, // CLR/HOME
                                          {{0,PS2_F7},{0,PS2_F8}},                      // f7
                                          {{0,PS2_F5},{0,PS2_F6}},                      // f5
                                          {{0,PS2_F3},{0,PS2_F4}},                      // f3
                                          {{0,PS2_F1},{0,PS2_F2}},                      // f1
                                          {{0,PS2_CRSR_DOWN},{0,PS2_CRSR_UP}},          // CRSR DOWN
                                          {{0,PS2_CRSR_RIGHT},{0,PS2_CRSR_LEFT}},       // CRSR RIGHT
                                         },
                                         // VICE mappins
                                         {
                                          {{0,PS2_2},{SCAN_MAP_SHIFT,PS2_2}},                 //2
                                          {{0,PS2_6},{SCAN_MAP_SHIFT,PS2_6}},                 //6
                                          {{0,PS2_7},{SCAN_MAP_SHIFT,PS2_7}},                 //7
                                          {{0,PS2_8},{SCAN_MAP_SHIFT,PS2_8}},                 //8
                                          {{0,PS2_9},{SCAN_MAP_SHIFT,PS2_9}},                 //9
                                          {{0,PS2_0},{SCAN_MAP_SHIFT,PS2_0}},                 //0
                                          {{0,PS2_MINUS},{SCAN_MAP_SHIFT,PS2_MINUS}},         //+
                                          {{0,PS2_LBRACKET},{SCAN_MAP_SHIFT,PS2_LBRACKET}},   //@
                                          {{0,PS2_RBRACKET},{SCAN_MAP_SHIFT,PS2_RBRACKET}},   //*
                                          {{0,PS2_SEMICOLON},{SCAN_MAP_SHIFT,PS2_SEMICOLON}}, //:
                                          {{0,PS2_RBRACKET},{SCAN_MAP_SHIFT,PS2_RBRACKET}},  //;
                                          {{0,PS2_BACKSLASH},{0,PS2_BACKSLASH}}, //=
                                          {{SCAN_MAP_EXT,PS2_DEL},{SCAN_MAP_SHIFT | SCAN_MAP_EXT,PS2_DEL}},//^ = DEL
                                          {{0,PS2_TAB},{SCAN_MAP_SHIFT,PS2_TAB}},             //CTRL
                                          {{0,PS2_BACKQUOTE},{SCAN_MAP_SHIFT,PS2_BACKQUOTE}}, //<-
                                          {{0,PS2_LCTRL},{SCAN_MAP_SHIFT,PS2_LCTRL}},         // C=
                                          {{0,PS2_ESC},{SCAN_MAP_SHIFT,PS2_ESC}},              // RUN-STOP
                                          {{SCAN_MAP_EXT,PS2_DEL},{SCAN_MAP_EXT | SCAN_MAP_SHIFT,PS2_DEL}},// RESTORE
                                          {{SCAN_MAP_EXT,PS2_HOME},{SCAN_MAP_SHIFT | SCAN_MAP_EXT,PS2_HOME}}, // CLR/HOME
                                          {{0,PS2_F7},{0,PS2_F8}},                      // f7
                                          {{0,PS2_F5},{0,PS2_F6}},                      // f5
...
static unsigned char joy_mapping[2][9][2]= {
                                               {
                                                 {SCAN_MAP_EXT,PS2_NUM_8},
                                                 {SCAN_MAP_EXT,PS2_NUM_7},
                                                 {SCAN_MAP_EXT,PS2_NUM_4},
                                                 {SCAN_MAP_EXT,PS2_NUM_1},
                                                 {SCAN_MAP_EXT,PS2_NUM_2},
                                                 {SCAN_MAP_EXT,PS2_NUM_3},
                                                 {SCAN_MAP_EXT,PS2_NUM_6},
                                                 {SCAN_MAP_EXT,PS2_NUM_9},
                                                 {SCAN_MAP_EXT,PS2_RCTRL}
                                                },
                                               {
                                                 {SCAN_MAP_EXT,PS2_NUM_8},
                                                 {SCAN_MAP_EXT,PS2_NUM_7},
